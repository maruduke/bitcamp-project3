...
checkService.getTemplate((res) => {
    ...
    document.querySelector('#category').innerHTML = res['typeData']['category'];
    document.querySelector('#cost').innerHTML = res['typeData']['cost'];
    document.querySelector('#expenseDate').innerHTML = res['typeData']['expenseDate'];
});
